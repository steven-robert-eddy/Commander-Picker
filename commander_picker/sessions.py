...
# ---- pod tracker: real multiplayer EDH games, players, decks ----
#
# Extends the same Elo idea the picker uses to actual games played at
# the table -- a genuine multiplayer generalization (elo.
# multiplayer_expected_scores/update_multiplayer_ratings), not naive
# pairwise decomposition, applied identically to two separate rated
# entities: players (freeform names, a row created implicitly the
